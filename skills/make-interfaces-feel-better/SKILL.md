...
When Charlie explicitly asks for a UI polish review or audit, read [`references/review-format.md`](references/review-format.md). Do not load that report contract for implementation or a narrow detail fix.
