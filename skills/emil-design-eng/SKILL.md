...
description: Emil Kowalski's technique reference for component behavior, CSS transforms, clip-path, gestures, and animation performance. Use when building or reviewing interactive UI details.
